    ...
    return(
        <main className="grow p-5">
                ...
                <tbody>
                    {
                        lista.map(p=>(
                            <tr key={p.id}>
                                ...
                                {' | '}
                                <button title="Excluir"className="text-red-700"onClick={()=>idModal(p.id)}><FaTrashAlt/></button></td>
                            </tr>
                        ))
                    }
                </tbody>
            ...
            <Modal open={open} onClose={()=>setOpen(false)}>
                ...
                <p className="text-gray-500 text-sm">Você tem certeza que desej excluir o produto?</p>
                </div>
